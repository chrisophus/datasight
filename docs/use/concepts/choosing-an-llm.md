...
See [Run on an HPC compute node](../how-to/run-on-hpc.md) for the
...
[Run on an HPC compute node](../how-to/run-on-hpc.md) and
[Connect to a remote Flight SQL backend](../how-to/connect-flight-sql.md).

## Configuring your choice

Once you've picked a provider, see the
[Install and configure an LLM](../../use/how-to/install.md) how-to for
